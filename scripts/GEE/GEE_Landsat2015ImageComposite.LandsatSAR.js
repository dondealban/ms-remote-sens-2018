...
Map.setCenter(98.64212,12.40975, 7); // Zoom in and center display to Taninintharyi Region, Myanmar
...
Map.addLayer(tni2015top, {bands: ['b5', 'b4', 'b3'], min: 0.05, max: [0.3,0.4,0.4], gamma: 1.6}, 'RGB 2015 Top Asset', true);
Map.addLayer(tni2015mid, {bands: ['b5', 'b4', 'b3'], min: 0.05, max: [0.3,0.4,0.4], gamma: 1.6}, 'RGB 2015 Mid Asset', true);
Map.addLayer(tni2015low, {bands: ['b5', 'b4', 'b3'], min: 0.05, max: [0.3,0.4,0.4], gamma: 1.6}, 'RGB 2015 Low Asset', true);

print('Top Composite:', tni2015top);
print('Mid Composite:', tni2015mid);
print('Low Composite:', tni2015low);
*/